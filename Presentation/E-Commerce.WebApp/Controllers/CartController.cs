...
namespace E_Commerce.WebApp.Controllers
{
    public class CartController : Controller
    {
        ...
        public CartController(ICartService cartservices, ICartItemService cartitemservice, IProductServices productservice, IUserIdentityRepository useridentityrepository)
        {
            ...
            if (!User.Identity.IsAuthenticated)
            {
                if (Request.Cookies.TryGetValue("cart", out string cartData))
                {
                    ...
                    foreach (var item in cartItems.CartItems)
                    {
                        ...
                        // 🔴 TEK VE ZORUNLU SATIR (HATAYI %100 ÇÖZER)
